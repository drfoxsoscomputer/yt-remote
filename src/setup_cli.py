...
def launch_wizard() -> int:
    ...
    if not is_configured():
        while True:
            ...
            print("=" * 50)
            print()
            print("Faltan sus datos. Solo se hace esto una vez.")
            print()
            print("El TOKEN es la llave de su bot. Para conseguirlo:")
            print("  1. Abre Telegram y busca a @BotFather")
            print("  2. Escríbele  /newbot   y sigue los pasos")
            print("  3. Le dará un código tipo:  123456:AAHxh...")
            print("     Ese es su TOKEN. Pegue el código completo aquí.")
            print()
            token = input("  Pegue su TOKEN aquí: ").strip()
            if not token or token == "TU_TOKEN_AQUI":
                print()
            ...
            print()
            print("Su ID numérico de Telegram (para que te reconozca como dueño):")
            print("  1. Abra Telegram y busque a @userinfobot")
            print("  2. Escríbale cualquier mensaje (por ejemplo: hola)")
            print("  3. Le dirá su ID, tipo:  123456789")
            print("     Ese es su ID. Escríbalo aquí.")
            print()
            owner = input("  Escriba su ID aquí: ").strip()
            if not owner:
                print()
            ...
            try:
                ...
                print()
                print("[Error] No se pudieron guardar los datos. Consulte la guía GUIA.txt")
                print("y verifique que la carpeta no tenga permisos de solo lectura.")
                print()
